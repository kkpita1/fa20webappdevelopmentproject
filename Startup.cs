...
using fa20team40finalproject.Models;
using fa20team40finalproject.DAL;


//TODO: Make this namespace match your project - be sure to remove the []
namespace fa20team40finalproject
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:fa20team40finalproject.database.windows.net,1433;Initial Catalog=fa20team40finalproject;Persist Security Info=False;User ID=MISAdmin;Password=Password123;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
        ...
        public void Configure(IApplicationBuilder app, IServiceProvider service)
        {
            ...
            //Seeding.SeedManagers.AddManager(service).Wait();
        }
    }   
}